...
{
    //Çalşma anından girilen nesneye göre uygulamanın istenilen biçimde çalıştırır, reflection bellekte oldukça yer kaplar.
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var instance = Activator.CreateInstance(type, 6, 4);
